...
use SAREhub\MicroODM\Test\DatabaseHelper;

class DatabasePingCheckerITest extends TestCase
{
    public function testExecuteWhenHostExists()
    {
        $client = DatabaseHelper::createClient(DatabaseHelper::getTestClientOptions());
    ...
    {
        $client = DatabaseHelper::createClient(ClientOptions::newInstance()->withHost("not_exists_host"));
        $checker = new DatabasePingChecker($client);
